...
% -----proxopt.alpha: alpha parameter (set between 0.01 and 0.3) MUST BE between 0 and 0.5.
...
function [hspatial, H, info] = proxacc_ZA(optfxn, gradfxn, H, proxopt, N, Nx)
...
if proxopt.alpha < 0 || proxopt.alpha > 0.5
